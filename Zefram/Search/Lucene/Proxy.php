...
class Zefram_Search_Lucene_Proxy implements Zend_Search_Lucene_Interface
{
    ...
    // Proxy methods automatically generated by build_proxy on 2014-07-22 19:00:00
    ...
    {
        return Zend_Search_Lucene::getActualGeneration($directory);
    }
    ...
    {
        return $this->_index->setFormatVersion($formatVersion);
    }
     ...
     * This may be used to, e.g., determine how big to allocate a structure which will
     * have
     ...
     * @param integer $id
     * @return boolean
     * @throws Zend_Search_Lucene_Exception    Exception is thrown if $id is out of the
     * range
     */
    ...
    {
        return Zend_Search_Lucene::setDefaultSearchField($fieldName);
    }
    ...
    {
        return Zend_Search_Lucene::setResultSetLimit($limit);
    }
    ...
    {
        return $this->_index->setMaxBufferedDocs($maxBufferedDocs);
    }
    ...
    {
        return $this->_index->setMaxMergeDocs($maxMergeDocs);
    }
    ...
    {
        return $this->_index->setMergeFactor($mergeFactor);
    }
    ...
    {
        return $this->_index->addDocument($document);
    }
    ...
    {
        return $this->_index->resetTermsStream();
    }
    ...
    {
        return $this->_index->closeTermsStream();
    }
}
