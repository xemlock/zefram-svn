...
/**
 * Factory for DbTable instances.
 *
 * @category   Zefram
 * @package    Zefram_Db
 * @subpackage Table
 */
class Zefram_Db_Table_Factory implements Zefram_Db_Table_FactoryInterface
{
    /**
    ...
    public function getTable($tableName, $db = null)
    {
        ...
        // pass this factory instance to the table
        ...
        if (strlen($this->_tablePrefix)) {
            if ($table instanceof Zefram_Db_Table) {
                ...
                // properties, we need to retrieve them by taking advantage of
                // how PHP engine casts objects to arrays.
                //
